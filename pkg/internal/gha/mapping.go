...
var (
	...
	imageRepo = map[string]string{
		...
		"rancher/rancher-ai-agent":                            "rancher/rancher-ai-agent",
		"rancher/rancher-ai-mcp":                              "rancher/rancher-ai-mcp",
	...
	identityOverride = map[string]string{
		...
		"rancher/rancher-ai-agent":                                        "^https://github.com/rancher/rancher-ai-agent/.github/workflows/release.yml@refs/tags/v",
